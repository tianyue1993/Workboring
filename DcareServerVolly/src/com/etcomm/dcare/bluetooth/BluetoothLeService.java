...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTING = "com.example.bluetooth.le.ACTION_GATT_DISCONNETING";
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                if(reConnectCount<=3){
                	...
                	if(mBluetoothDeviceAddress!=null){
                		...
                		Log.e(TAG, "mBluetoothDeviceAddress error cannot reconnect");
                	}
                }else{
                	Log.e(TAG, "reConnectCount > 3 error");
                }
                broadcastUpdate(intentAction);
