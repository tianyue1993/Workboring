...
//		params.put("access_token", AppSharedPreferencesHelper.getAccessToken());
        cancelmDialog();
...
//		dialog.show();
        ...
        DcareRestClient.volleyGet(Constants.GetPointsRules, params, new FastJsonHttpResponseHandler() {
            @Override
...
//				super.onReceivedError(view, errorCode, description, failingUrl);
    ...
    protected int setLayoutId() {
        return R.layout.activity_pointscollectdetail;
    }
}
