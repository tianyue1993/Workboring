...
public class MsgPhotoGridAdapter extends DcareBaseAdapter<String> {

	private int picwidth;

	public MsgPhotoGridAdapter(Context mContext, List<String> photos, int mWidth) {
		super(mContext);
		this.mList = photos;
...
//			convertView.setLayoutParams(new LayoutParams(picwidth, picwidth));
		...
		Log.i(tag, mInfo);
		imageLoader.displayImage(mInfo, holder.photo_image,options);
		return convertView;
	}
