...
public class AroundNotAttentioned2ListAdapter extends DcareBaseAdapter<NotAttentionedItems> {
    ...
    public AroundNotAttentioned2ListAdapter(Context context, ArrayList<NotAttentionedItems> mList, NotAttentionAttentioned listener) {
        super(context);
        this.mList = mList;
    ...
    public interface NotAttentionAttentioned {
        void onAttentioned(NotAttentionedItems item);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final NotAttentionedItems mInfo = getItem(position);
        if (null != mInfo) {
    ...
    protected void attention(final NotAttentionedItems mInfo) {
        // TODO Auto-generated method stub
    ...
    public void alterData(ArrayList<NotAttentionedItems> mAttentionList) {
        // TODO Auto-generated method stub
        if (mList != null) {
            mList.clear();
        }
