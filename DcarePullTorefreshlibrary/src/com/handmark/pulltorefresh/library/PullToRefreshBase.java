...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private void addRefreshableView(Context context, T refreshableView) {
		...
		/// 1433131200 6-1-12 1431417600 5-12-16 1434600000 6-18-12 1431497400
		/// 5-13-14-10 6-30 1435636800 1438056000
		// if(System.currentTimeMillis()/1000>1438056000){
		...
		// Toast.makeText(getContext(), "app"+""+"初始化"+""+"失败",
